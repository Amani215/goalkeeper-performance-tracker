...
import { Login, Dashboard, Users, User, Goalkeepers, Goalkeeper, Categories, Category, Documents, Trainings, Training, Matches, Match, MatchPerformancePage, Logout, Settings } from '../pages';
